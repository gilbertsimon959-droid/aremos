...
export function setToken(jwt: string) {
  ...
  // Set Cookie für Middleware-Protection
  // Hinweis: HttpOnly kann nicht via JS gesetzt werden; im Dev ohne Secure-Flag, in Prod mit Secure
...
export function clearToken() {
  ...
  // Cookie löschen (Dev ohne Secure, Prod mit Secure)
  const isProd = process.env.NODE_ENV === "production";
  const secure = isProd ? "; Secure" : "";
